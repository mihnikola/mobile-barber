  ...
  return (
    <ScrollView style={styles.container}>
      <Image
        ...
        resizeMode="cover"
      />
      <Text style={styles.header}># Terms of Service for Barber Demo App</Text>
      ...
      <Text style={styles.paragraph}>
        This Terms of Service describes how FusionTech Agency. We collects, uses, and discloses
